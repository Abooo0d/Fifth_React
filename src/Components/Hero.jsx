...
const Hero = () => (
  <section
    id={"home"}
    className={`flex md:flex-row flex-col ${styles.paddingY} max-h-[90%]`}
  >
    <div
    ...
    >
      ...
      <div className="flex flex-row justify-between items-center w-full">
        ...
        <div className="ss:flex hidden md:mr-4 mt-0">
          <GetStarted />
        </div>
      </div>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
        ...
        ducimus iste reprehenderit, vero obcaecati tempore aliquam suscipit
        voluptatum molestiae provident sunt tempora, odio facilis!
      </p>
    </div>
    <div className={`flex flex-1 relative ${styles.flexCenter} md:my-0 my-10 `}>
      <img src={robot} alt="billing" className="w-[100%] z-[5]" />
      <div className="absolute z-[0] h-[35%] w-[40%] top-0 pink__gradient" />
      <div className="absolute z-[1] h-[85%] w-[80%] rounded-full bottom-40 white__gradient" />
